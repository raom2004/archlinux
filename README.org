...
- Who may read this repository
  ...
  - Had installed Arch Linux before and want to automate the process using scripts? 
    This repository is for you!

  - Hadn't you installed Arch Linux before but definitely wants to have a look over the commands required? 
    This repository is also for you!
