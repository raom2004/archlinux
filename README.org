...
Well, *you can automatize the Arch Linux installation using the scripts described in this repository*, with tips and recommendations found in the official documentation and Arch Linux forums.

Who may read this repository:

 - Everyone who has installed Arch Linux before and want to automate the process using scripts? this repository is for you!

 - Everyone who hadn't installed Arch Linux before but definitely wants to have a look over the commands required? this repository is also for you!
