...
Well, *you can automatize the Arch Linux installation using the scripts described in this repository*, with tips and recommendations found in the documentation and forums. So, this repository is useful for everyone who has installed Arch Linux before and wants to automatize the process using scripts, or someone who has not installed Arch Linux before but definitely wants to have a look over the commands required. Both cases, this repository is definitely for that!
