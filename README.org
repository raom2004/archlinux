...
- Who may read this repository
  ...
  - Had installed Arch Linux before and want to automate the process using scripts? Well, this repository is for you!

  - Hadn't you installed Arch Linux before but definitely wants to have a look over the commands required? this repository is also for you!
